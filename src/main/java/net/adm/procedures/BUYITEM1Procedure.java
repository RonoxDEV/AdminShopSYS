...
public class BUYITEM1Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (new Object() {
		...
		}.convert(AdmModVariables.MapVariables.get(world).Item1MONEY) <= getAmountInGUISlot(entity, 0) && AdmModVariables.MapVariables.get(world).ItemMONEY
			...
			if (entity instanceof Player _player && _player.containerMenu instanceof AdmModMenus.MenuAccessor _menu) {
				...
				}.convert(AdmModVariables.MapVariables.get(world).Item1MONEY));
